            ...
            Alert.alert("Sucesso!", "Vacinas registradas com sucesso!", [
                {
                    ...
                    onPress: () => router.push({
                        pathname: './confirmacao_registro', 
                        params: {
                            dadosPaciente: JSON.stringify(paciente),
                            dadosVacinas: JSON.stringify(registros),
                            dadosProfissional: JSON.stringify(profissionalLogado)
                        }
                    })
                }
            ]);
